...
class StrategyLearner(object):
    ...
    def __init__(self, num_shares=1000, epochs=1000, num_steps=10,
    ...
    def get_thresholds(self, df_features, num_steps):
        ...
        step_size = int(df_features.shape[0] / num_steps)
    ...
    def addEvidence(self, symbol="IBM", sd=dt.datetime(2008,1,1),
        ...
        sv: Start value of the portfolio which contains only the symbol
        """
